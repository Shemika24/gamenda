...
<head>
    ...
    <title>Cookie Policy - Gamenda</title>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="bg-gray-800 rounded-2xl p-8 md:p-12">
            <div class="prose prose-invert prose-purple max-w-none">
                <section class="mb-8">
                    <h2 class="text-2xl font-bold text-purple-400 mb-4">1. What Are Cookies</h2>
                ...
                <section class="mb-8">
                    <h2 class="text-2xl font-bold text-purple-400 mb-4">2. How We Use Cookies</h2>
                    <p class="text-gray-300 mb-4">
                    ...
                    <ul class="list-disc list-inside text-gray-300 space-y-2 ml-4">
                        ...
                        <li><strong>Analytics Cookies:</strong> Help us improve our website by collecting usage data</li>
                    </ul>
                </section>

                <section class="mb-8">
                    <h2 class="text-2xl font-bold text-purple-400 mb-4">3. Types of Cookies We Use</h2>
                    
                    <h3 class="text-xl font-semibold text-white mb-3">Essential Cookies</h3>
                    <p class="text-gray-300 mb-4">
                        These cookies are necessary for the website to function and cannot be switched off in our systems.
                    </p>
                    
                    <h3 class="text-xl font-semibold text-white mb-3">Performance and Analytics Cookies</h3>
                    <p class="text-gray-300 mb-4">
                        These cookies allow us to count visits and traffic sources so we can measure and improve the performance of our site.
                    </p>
                    
                    <h3 class="text-xl font-semibold text-white mb-3">Functionality Cookies</h3>
                    <p class="text-gray-300 mb-4">
                        These cookies enable the website to provide enhanced functionality and personalization.
                    </p>
                    
                    <h3 class="text-xl font-semibold text-white mb-3">Targeting Cookies</h3>
                ...
                <section class="mb-8">
                    <h2 class="text-2xl font-bold text-purple-400 mb-4">4. Third-Party Cookies</h2>
                    <p class="text-gray-300 mb-4">
                        In some special cases, we also use cookies provided by trusted third parties. The following section details which third party cookies you might encounter through this site:
                    </p>
                    <ul class="list-disc list-inside text-gray-300 space-y-2 ml-4">
                        <li><strong>Google Analytics:</strong> One of the most widespread and trusted analytics solutions on the web</li>
                        <li><strong>Advertising Partners:</strong> Cookies from our advertising partners to deliver relevant ads</li>
                        <li><strong>Social Media:</strong> Cookies from social media platforms for sharing content</li>
                    </ul>
                </section>

                <section class="mb-8">
                    <h2 class="text-2xl font-bold text-purple-400 mb-4">5. Managing Cookies</h2>
                    <p class="text-gray-300 mb-4">
                    ...
                    <p class="text-gray-300">
                        To find out more about cookies, including how to see what cookies have been set and how to manage and delete them, visit <a href="https://www.aboutcookies.org" class="text-purple-400 hover:text-purple-300">www.aboutcookies.org</a>.
                    </p>
                </section>

                <section class="mb-8">
                    <h2 class="text-2xl font-bold text-purple-400 mb-4">6. Your Choices</h2>
                    <p class="text-gray-300 mb-4">
                        Most web browsers allow some control of most cookies through the browser settings. To find out more about cookies, including how to see what cookies have been set and how to manage and delete them, visit:
                    </p>
                    <ul class="list-disc list-inside text-gray-300 space-y-2 ml-4">
                        <li><a href="https://support.google.com/chrome/answer/95647" class="text-purple-400 hover:text-purple-300">Google Chrome</a></li>
                        <li><a href="https://support.mozilla.org/en-US/kb/enable-and-disable-cookies-website-preferences" class="text-purple-400 hover:text-purple-300">Mozilla Firefox</a></li>
                        <li><a href="https://support.microsoft.com/en-us/windows/microsoft-edge-browsing-data-and-privacy-bb8174ba-9d73-dcf2-9b4a-c582b4e640dd" class="text-purple-400 hover:text-purple-300">Microsoft Edge</a></li>
                ...
                <section class="mb-8">
                    <h2 class="text-2xl font-bold text-purple-400 mb-4">7. Changes to This Cookie Policy</h2>
                    <p class="text-gray-300">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="cookies.php" class="text-purple-400 font-medium">Cookie Policy</a></li>
